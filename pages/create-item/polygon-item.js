...
import {
    mumbainftaddress, mumbaimarketaddress
} from '../../config';
...
export default function CreateItem() {
    ...
    async function createSale(url) {
        ...
        contract = new ethers.Contract(mumbaimarketaddress, Market.abi, signer);
        ...
        transaction = await contract.createMarketItem(
            mumbainftaddress, tokenId, price, { value: listingPrice }
        )

        await transaction.wait()

        router.push('/sellnft/polygonform')
