...
import {
    bscmarketaddress, bscnftaddress
} from '../../config';
...
export default function CreateItem() {
    ...
    async function createSale(url) {
        ...
        let contract = new ethers.Contract(bscnftaddress, NFT.abi, signer);
        ...
        contract = new ethers.Contract(bscmarketaddress, Market.abi, signer);
        ...
        transaction = await contract.createMarketItem(
            bscnftaddress, tokenId, price, { value: listingPrice }
        )

        await transaction.wait()

        router.push('/sellnft/bscform')
